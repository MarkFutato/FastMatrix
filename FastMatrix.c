...
typedef long long ll; // truncate long long so i don't have to type it so many times

/**
 * @brief Multiplies two 3x3 matrices modulo MOD.
 *
 * Performs matrix multiplication on two 3x3 matrices, `A[][]` and `B[][]`, modulo MOD, defined above.
